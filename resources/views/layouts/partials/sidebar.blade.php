<aside 
    ...
    class="absolute left-0 top-0 z-9999 flex h-screen w-0 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static " {{-- lg:translate-x-0 --}}
    >
    
    <!-- SIDEBAR HEADER -->
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="">
            <img src="{{URL::to('/')}}/images/logo/LogoBlanco.png" alt="Logo" />
        </a>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="#" @click.prevent="selected = (selected === 'catalogues' ? '':'catalogues')"
                            :class="{
                                'bg-graydark dark:bg-meta-4': (selected === 'catalogues') || (page ===
                                    'AdministrativeUnits' ||
                                    page === 'Submenus')
                            }">
                            ...
                            <svg class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                                :class="{ 'rotate-180': (selected === 'catalogues') }" width="20" height="20"
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="overflow-hidden" :class="(selected === 'catalogues') ? 'block' : 'hidden'">
                            <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('administrativeUnit.index') }}"
                                        :class="page === 'AdministrativeUnits' && '!text-white'">Unidades</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('submenu.index') }}"
                                        :class="page === 'Submenus' && '!text-white'"> Submenús </a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('sheetNumber.index') }}" @click="selected = (selected === 'SheetNumber' ? '':'SheetNumber')"
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden" :class="(selected === 'Forms') ? 'block' : 'hidden'">
                            <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                ...
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="form-layout.html" :class="page === 'other' && '!text-white'">Form
                                        Layout</a>
                                </li>
                            </ul>
                        </div>
