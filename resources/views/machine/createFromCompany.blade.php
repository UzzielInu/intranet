        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="border-b border-stroke py-4 px-6.5 dark:border-strokedark flex justify-center">
                <h3 class="font-semibold text-black dark:text-white text-lg">
                    Crear máquina en : <span class="text-md text-orange-800 dark:text-orange-700"> {{$area->company->name}} </span>
                </h3>
                @if ($errors->any())
                    <script>
            ...
            <form method="POST" action="{{ route('machine.store') }}" autocomplete="off">
                @csrf
                <div class="p-6.5">
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row justify-center content-center">
                        ...
                        <div class="w-full flex flex-row">
                            <label class="flex my-auto mr-2 text-black dark:text-white">
                                HP <span class="text-meta-1">*</span>
                            </label>
                            <input type="numeric" placeholder="Caballos de fuerza (HP)" name="hp" required pattern="\d*" title="Solo se permiten números" inputmode="numeric"
                    ...
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row justify-center content-center">
                        <div class="w-full flex flex-row">
                            <label class="flex my-auto mr-2 text-black dark:text-white">
                                Voltaje <span class="text-meta-1">*</span>
                            </label>
                            <input type="text" placeholder="Voltaje (Volts)" name="voltage" required pattern="\d*" title="Solo se permiten números" inputmode="numeric"
                                oninput="this.value = this.value.replace(/[^0-9]/g, '');"
                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                        </div>
                        <div class="w-full flex flex-row">
                    ...
                    <div class="mb-4.5 flex-col gap-6 xl:flex-row justify-center content-center hidden">
                        <div class="w-2/3 flex flex-row">
                            ...
                            <input type="text" placeholder="" name="area" value="{{$area->id}}"
                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                        </div>
                    </div>
