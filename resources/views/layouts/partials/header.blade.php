<header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
    <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
        <div class="flex items-center gap-2 sm:gap-4">
            ...
            <button
                class="z-99999 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark md:hidden"
                @click.stop="sidebarToggle = !sidebarToggle" :value="deskToggle">
            ...
            <!-- Hamburger Toggle BTN -->
            <button
                class="hidden md:block z-99999 rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark"
                @click.stop="deskToggle = !deskToggle" :value="deskToggle">

                <span class="relative h-5.5 w-5.5 cursor-pointer">
            ...
            {{-- <form action="https://formbold.com/s/unique_form_id" method="POST">
                <div class="relative">
                    ...
                    <input type="text" placeholder="Type to search..."
                        class="w-full bg-transparent pr-4 pl-9 focus:outline-none border-none" />
                </div>
            </form> --}}
        </div>
                        ...
                        <ul class="flex h-auto flex-col overflow-y-auto">
                            <li>
                                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                    ...
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{ URL::to('/') }}/images/user/user-02.png" alt="User" />
                                    </div>
                            ...
                            <li>
                                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{ URL::to('/') }}/images/user/user-01.png" alt="User" />
                                    </div>
                            ...
                            <li>
                                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{ URL::to('/') }}/images/user/user-03.png" alt="User" />
                                    </div>
                            ...
                            <li>
                                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{ URL::to('/') }}/images/user/user-04.png" alt="User" />
                                    </div>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                    <span class="hidden text-right lg:block">
                        ...
                        <span class="block text-xs font-medium">Rol esperado</span>
                    </span>
